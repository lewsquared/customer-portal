...
export const MOCK_PORTAL_DATA = {
  ...
  approvalItems: [
    { id: "a0", brand: "Calvin Klein", itemType: "Dress shirt", color: "Navy",
      ...
      issues: [{ type: "stain" as const, location: "Collar front", facilityNote: "Oil stain ~2cm. Likely to respond to CP treatment.", photoCoords: { x: 52, y: 26 } }],
    ...
    { id: "a1", brand: "Ralph Lauren", itemType: "Linen trousers", color: "Beige",
      ...
      issues: [{ type: "stain" as const, location: "Left knee", facilityNote: "Grass stain. Best treated with CP.", photoCoords: { x: 38, y: 58 } }],
