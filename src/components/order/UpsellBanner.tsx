...
export const UpsellBanner = () => {
  return (
    ...
    >
      <button
        type="button"
        className="group relative flex w-full items-center gap-4 overflow-hidden rounded-xl border border-border bg-gradient-to-br from-secondary to-surface-lavender-soft p-4 text-left transition-transform duration-100 ease-out active:duration-75 active:scale-[0.99]"
      >
