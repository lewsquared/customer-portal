...
export const ReviewBanner = ({ count = 3 }: Props) => {
  return (
    <section className="mt-5 px-5 animate-fade-in" style={{ animationDelay: "60ms" }}>
      <button
        type="button"
        className="group flex w-full items-center gap-3 rounded-xl border border-warning/40 bg-warning/15 p-4 text-left shadow-card transition-all hover:bg-warning/20 active:scale-[0.99]"
      >
