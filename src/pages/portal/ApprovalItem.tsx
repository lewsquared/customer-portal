              ...
              {(item as any).wfReason && (
                <>
                  ...
                  <div className="mt-2 rounded-xl border border-border bg-card px-4 py-3">
                    <p className="text-muted-foreground whitespace-pre-line" style={{ fontSize: "14px", lineHeight: "20px", fontWeight: 100 }}>
                ...
                {(["CP", "WF"] as const).map((id) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {id === "CP" && (
                        <span className="absolute right-0 top-0 rounded-bl-lg rounded-tr-xl px-2.5 py-1 text-[10px] font-normal text-primary" style={{ backgroundColor: "#A4FF00" }}>
                          Recommended
                        </span>
                      )}
                      {/* Radio circle */}
