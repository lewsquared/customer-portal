...
const EmptyActive = () => (
  <div className="flex h-60 flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-border bg-card/50 px-6 text-center">
    ...
    <button
      ...
      className="mt-2 w-full rounded-[6px] bg-primary px-4 py-3 text-sm font-bold text-primary-foreground shadow-press transition-transform duration-100 ease-out active:duration-75 active:scale-[0.97]"
    >
      Place an order
    </button>
  </div>
